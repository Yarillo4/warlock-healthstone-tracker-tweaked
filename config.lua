...
local L_CACHE_DESCRIPTION = L["Here you can override the healthstone status of players. Normally you shouldn't need to use this, but it can be useful in specific circumstances."]
local L_PARTY_RAID_MEMBERS = L["Party and Raid members"]
local L_PARTY = PARTY
local L_RAID = RAID
            ...
            args = {
                resetDefaults = {
                    ...
                    func = function()
                        ...
                        optionListeners:Fire("ListView/Enabled", C:get("ListView/Enabled"))
